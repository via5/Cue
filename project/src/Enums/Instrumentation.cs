...
namespace Cue
{
	public class I
	{
		...
		public static readonly InstrumentationType GazeCustom = InstrumentationType.CreateInternal(22);
		public static readonly InstrumentationType GazePostTarget = InstrumentationType.CreateInternal(23);
		public static readonly InstrumentationType Voice = InstrumentationType.CreateInternal(24);
		public static readonly InstrumentationType Excitement = InstrumentationType.CreateInternal(25);
		public static readonly InstrumentationType Mood = InstrumentationType.CreateInternal(26);
		public static readonly InstrumentationType Body = InstrumentationType.CreateInternal(27);
		public static readonly InstrumentationType BodyZap = InstrumentationType.CreateInternal(28);
		public static readonly InstrumentationType BodyParts = InstrumentationType.CreateInternal(29);
		public static readonly InstrumentationType BodyZones = InstrumentationType.CreateInternal(30);
		public static readonly InstrumentationType ZoneDecay = InstrumentationType.CreateInternal(31);
		public static readonly InstrumentationType ZoneUpdate = InstrumentationType.CreateInternal(32);
		public static readonly InstrumentationType ZoneIgnore = InstrumentationType.CreateInternal(33);
		public static readonly InstrumentationType BodyTemperature = InstrumentationType.CreateInternal(34);
		public static readonly InstrumentationType BodyVoice = InstrumentationType.CreateInternal(35);
		public static readonly InstrumentationType Homing = InstrumentationType.CreateInternal(36);
		public static readonly InstrumentationType Status = InstrumentationType.CreateInternal(37);
		public static readonly InstrumentationType AI = InstrumentationType.CreateInternal(38);
		public static readonly InstrumentationType Triggers = InstrumentationType.CreateInternal(39);
		public static readonly InstrumentationType Finish = InstrumentationType.CreateInternal(40);
		public static readonly InstrumentationType UI = InstrumentationType.CreateInternal(41);
		public static readonly InstrumentationType FixedUpdate = InstrumentationType.CreateInternal(42);
		public static readonly InstrumentationType FUSys = InstrumentationType.CreateInternal(43);
		public static readonly InstrumentationType FUObjects = InstrumentationType.CreateInternal(44);
		public static readonly InstrumentationType FUBody = InstrumentationType.CreateInternal(45);
		public static readonly InstrumentationType FUAnimator = InstrumentationType.CreateInternal(46);
		public static readonly InstrumentationType FUAI = InstrumentationType.CreateInternal(47);
		public static readonly InstrumentationType FUExpressions = InstrumentationType.CreateInternal(48);
		public static readonly InstrumentationType LateUpdate = InstrumentationType.CreateInternal(49);
		public static readonly InstrumentationType Collisions = InstrumentationType.CreateInternal(50);
		public static readonly InstrumentationType ColWithThis = InstrumentationType.CreateInternal(51);
		public static readonly InstrumentationType ColGetBP = InstrumentationType.CreateInternal(52);
		public static readonly InstrumentationType ColExternal = InstrumentationType.CreateInternal(53);
		public static readonly InstrumentationType ColPerson = InstrumentationType.CreateInternal(54);

		public const int Count = 55;
		public int GetCount() { return 55; }
	}
	...
	public struct InstrumentationType
	{
		...
		private static InstrumentationType[] values_ = new InstrumentationType[]
		{
			...
			InstrumentationType.CreateInternal(54),
		};
