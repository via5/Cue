namespace Cue.Proc
{
	class BuiltinExpressions
	{
		public static IProceduralMorphGroup Smile(Person p)
		{
			...
			g.Add(new ClampableMorph(p, BodyParts.Mouth, "Smile Open Full Face", 0, 1, 0.3f, 3, 2, 1));
			return g;
		}
		...
		public static IProceduralMorphGroup CornerSmile(Person p)
		{
			...
			g.Add(new ClampableMorph(p, BodyParts.Mouth, "Mouth Smile Simple Left", 0, 1, 1, 5, 2, 2));
			return g;
		}
		...
		public static IProceduralMorphGroup Pleasure(Person p)
		{
			...
			g.Add(new ClampableMorph(p, BodyParts.Mouth, "07-Extreme Pleasure", 0, 1, 1, 5, 2, 2));
			g.Add(new ClampableMorph(p, BodyParts.Mouth, "Pain", 0, 0.5f, 1, 5, 2, 2));
			g.Add(new ClampableMorph(p, BodyParts.Mouth, "Shock", 0, 1, 1, 5, 2, 2));
			g.Add(new ClampableMorph(p, BodyParts.Mouth, "Scream", 0, 1, 1, 5, 2, 2));
			g.Add(new ClampableMorph(p, BodyParts.Mouth, "Angry", 0, 0.3f, 1, 5, 2, 2));
		...
		public static IProceduralMorphGroup EyesClosed(Person p)
		{
			...
			var eyesClosed = new ClampableMorph(p, BodyParts.Eyes, "Eyes Closed", 0, 1, 0.5f, 5, 2, 2);
		...
		public static IProceduralMorphGroup Drooling(Person p)
		{
			...
			g.Add(new ClampableMorph(p, BodyParts.Mouth, "Mouth Open", 0, 1, 2, 5, 3, 3));
			return g;
		}
		...
		public static IProceduralMorphGroup EyesClosedTired(Person p)
		{
			...
			var eyesClosed = new ClampableMorph(p, BodyParts.Eyes, "Eyes Closed", 0.2f, 1, 2, 5, 3, 3);
			eyesClosed.DisableBlinkAbove = 0.5f;
			g.Add(eyesClosed);
