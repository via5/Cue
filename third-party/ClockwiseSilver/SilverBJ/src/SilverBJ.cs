...
//------------------------------------UI----------------------------------------------------------
				...
				rangeMultiJSON = Helpers.SetupSlider(this, "Overall Range", 1f, 0.2f, 2.0f, false);
				...
				minRangeJSON = Helpers.SetupSlider(this, "Range Min", 0.6f, 0.5f, 1.59f, false);
				maxRangeJSON = Helpers.SetupSlider(this, "Range Max", 1.7f, 1.1f, 1.7f, false);
				...
				lipsMaxJSON = Helpers.SetupSlider(this, "Lip Morph Max", 0.5f, 0f, 2f, true);
				mouthOpenWideMaxJSON = Helpers.SetupSlider(this, "Mouth Open Max", 0.8f, -1f, 1f, true);
